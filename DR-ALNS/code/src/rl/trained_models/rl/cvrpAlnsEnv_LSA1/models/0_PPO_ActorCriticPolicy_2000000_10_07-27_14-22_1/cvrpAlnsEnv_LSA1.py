...
from routing.cvrp.alns_cvrp.destroy_operators import (random_removal,worst_dist_cust_removal, worst_time_cust_removal,
                                                      shaw_destroy,
                                                      proximity_based_removal, time_based_removal, zone_removal,
                                                      shortest_route_removal, least_cus_route_removal,
                                                      random_route_removal)
from routing.cvrp.alns_cvrp.repair_operators import (regret_insertion, random_repair, time_based_repair,
                                                     regret_2_insertion, regret_3_insertion, greedy_repair)
